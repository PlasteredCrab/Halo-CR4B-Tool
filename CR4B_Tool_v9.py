...
def Start_CR4B_Tool():
    ...
    def get_bitmap_curve (directory):
        ...
        try:    
            ...
            curve_option = 6
            print("Failed to read bitmap file color curve data")
    ...
    def get_wrap_mode_list(file, shader_type, ShaderItem):
        ...
        if(shader_type == 0):    
            ...
            if(shader_shader_offset != 0):
                ...
                print("List of wrap modes: " + str(temp_wrap_list))
                print("List of wrap type options: " + str(temp_wrap_option))
            ...
            if(has_rgb_alpha(file, offset) == True): #has both
                ...
                if (temp_leftB1 == 0.0): #we might be aligned but check to the left of that to make sure it is not 0.0 as well
                    if (temp_leftB2 == 0.0): #we are not aligned set offset + 0x83
                        print("env_tint_color needs shifted to left by 1 byte")
    ...
    def apply_group_values(NodeGroup, ShaderItem, category):
        ...
        #self illum group
            ...
            # elif(Shader_Type == 3 and ShaderItem.self_illumination_option == 10): #H3Category: self_illumination - ml_add_four_change_color
                # #add these in later
                # print("self_illumination - ml_add_four_change_color")
            elif(ShaderItem.self_illumination_option == 11 and Shader_Type != 3): #H3Category: self_illumination - illum_change_color
                NodeGroup.inputs.get("self_illum_intensity").default_value = ShaderItem.self_illum_intensity
                NodeGroup.inputs.get("primary_change_color_blend").default_value = ShaderItem.primary_change_color_blend
        ...
        for root, dirs, files in os.walk(Tag_Root):
            ...
            if (ShaderName in files):
                ...
                if (Shader_Type == 0 or Shader_Type == 2 or Shader_Type == 3):   #then search for this data below
                    ...
                    try: 
                        ...
                        if(debug_textures_values_found != 0):
                            print("detail_map_overlay not found!")                                          
                    try: 
                    ...
                    try: #check for color_mask_map
                        ...
                        if(debug_textures_values_found != 0):                        
                            print("color_mask_map not found!")        
                    ...
                    try: 
                        ...
                        if (test_find(Env_Tint_Color_Offset, shaderfile, "env_tint_color") != -1):
                            print("grabbing second env tint color offset")
                ...
                if (Game_Source == "H3" or Game_Source == "H3ODST"):
                    ...
                    if (Shader_Type == 0):
                        ...
                        if (CategoryOptions_Offset != 0):
                                ...
                                print("distortion option: " + get_parallax_option(ShaderItem.distortion_option))
                                print("soft fade option: " + get_misc_option(ShaderItem.soft_fade_option))
                ...
                ### HALO REACH CATEGORIES ###
                    ...
                    if (Shader_Type == 0):
                        ...
                        if (CategoryOptions_Offset != 0):
                                ...
                                print("albedo option: " + get_reach_albedo_option(ShaderItem.albedo_option))
                                print("bump_mapping option: " + get_reach_bump_mapping_option(ShaderItem.bump_mapping_option))
                                print("alpha_test option: " + get_alpha_test_option(ShaderItem.alpha_test_option))
                                print("specular_mask option: " + get_reach_specular_mask_option(ShaderItem.specular_mask_option))
                                print("material_model option: " + get_reach_material_model_option(ShaderItem.material_model_option))
                                print("environment_mapping option: " + get_environment_mapping_option(ShaderItem.environment_mapping_option))
                                print("self_illumination option: " + get_reach_self_illumination_option(ShaderItem.self_illumination_option))
                                print("blend_mode option: " + get_blend_mode_option(ShaderItem.blend_mode_option))
                                print("parallax option: " + get_parallax_option(ShaderItem.parallax_option))
                                print("misc option: " + get_reach_misc_option(ShaderItem.misc_option))
                                print("wetness option: " + get_reach_wetness_option(ShaderItem.wetness_option))
                                print("alpha blend source option: " + get_reach_alpha_blend_source_option(ShaderItem.alpha_blend_source_option))
                ...
                if (ColorMaskMap_Offset != 0):
                    #print("color_mask_map offset: " + str(ColorMaskMap_Offset))
                    print("")
                    print("[color_mask_map]") 
                ...
                if (Albedo_Color2_Offset != 0):  #color
                    #print("albedo_color2 offset: " + str(Albedo_Color2_Offset))
                    ...
                    if(has_value(shaderfile, Albedo_Color2_Offset + 0xD + 0x1) == True):
                        ...
                        print("albedo_color2: " + str(ShaderItem.albedo_color2))
                        ShaderItem.albedo_color2_alpha = get_rgb(shaderfile, Albedo_Color2_Offset + 0xD + 0x1, "alpha")
                        print("albedo_color2_alpha: " + str(ShaderItem.albedo_color2_alpha))
                    else: #use default value
                        ShaderItem.albedo_color2 = color_white_rgb
                        print("albedo_color2 value/color not found. Using Default Value")
                    ...
                    if(has_function(shaderfile, Albedo_Color2_Offset + 0xD + 0x1) == True): #value/color has function
                        ...
                        print("  New Value from function: " + str(ShaderItem.albedo_color2))
                        ShaderItem.function_list.append(FunctionItem)     
                if (Albedo_Color3_Offset != 0):  #color
                    #print("albedo_color3 offset: " + str(Albedo_Color3_Offset))
                    ...
                    if(has_value(shaderfile, Albedo_Color3_Offset + 0xD + 0x1) == True):
                        ...
                        print("albedo_color3: " + str(ShaderItem.albedo_color3))
                        ShaderItem.albedo_color3_alpha = get_rgb(shaderfile, Albedo_Color3_Offset + 0xD + 0x1, "alpha")
                        print("albedo_color3_alpha: " + str(ShaderItem.albedo_color3_alpha))
                    else: #use default value
                        ShaderItem.albedo_color3 = color_white_rgb
                        print("albedo_color3 value/color not found. Using Default Value")
                    ...
                    if(has_function(shaderfile, Albedo_Color3_Offset + 0xD + 0x1) == True): #value/color has function
                        ...
                        print("  New Value from function: " + str(ShaderItem.albedo_color3))
                        ShaderItem.function_list.append(FunctionItem)     
                ...
                if((Shader_Type == 0 or Shader_Type == 3) and ShaderItem.self_illumination_option == 1): #H3RCategory: self_illumination - simple
                    ...
                    ShaderGroupList.append("self_illum")
                    illum_group_made = 1
                elif((Shader_Type == 0 or Shader_Type == 3) and ShaderItem.self_illumination_option == 11): #H3Category: self_illumination - illum_change_color
            ...
            #create variable for each category maybe to correct any misassignment?
                ...
                if((Shader_Type == 0 or Shader_Type == 3 or Shader_Type == 2) and ShaderItem.albedo_option == 0): #H3RCategory: albedo - default 
                    ...
                    ShaderGroupList.append("albedo")
                    albedo_group_made = 1
                elif((Shader_Type == 0 or Shader_Type == 3) and ShaderItem.albedo_option == 9): #H3RCategory: albedo - two_detail_black_point
                ...
                if(Shader_Type == 0 and ShaderItem.environment_mapping_option == 1): #CR4BUtility: environment_map Reflector
                ...
                print(str(Shader_Type) + " " + str(ShaderItem.bump_mapping_option) + " " + str(ShaderItem.environment_mapping_option))
                #CONNECT "BUMP GROUP" TO "ENVIRONMENT MODEL" GROUP
                if(Shader_Type == 0 and ShaderItem.bump_mapping_option != 0 and (ShaderItem.environment_mapping_option == 1 or ShaderItem.environment_mapping_option == 2)): #when Environment Mapping Option is "dynamic"
                ...
                if(Shader_Type == 0 and ShaderItem.bump_mapping_option != 0 and (ShaderItem.environment_mapping_option == 1)): #when Environment Mapping Option is "dynamic"
                        ...
                        if (is_valid_dir(ShaderItem.bitmap_list[bitm].directory) == True):    
                            ...
                            try:
                                ...
                                if (uses_gray_50(ShaderItem.bitmap_list[bitm].type) == True):
                                    ...
                                    print("default dynamic cubemap has been added to " + ShaderItem.bitmap_list[bitm].type)
                                    #BE SURE TO ADD IN DEFAULT DATA AS WELL LATER
                                    texture_node_made = 1
                            ...
                            try:
                                if (ShaderItem.bitmap_list[bitm].type == "environment_map"):
                                    ...
                                    print(EnvTextureNodeList[env_tex_index + 1].name)
                                    print(EnvTextureNodeList[env_tex_index + 2].name)
                                else:    
                            ...
                            if(ShaderItem.bitmap_list[bitm].curve_option == 0 and bitmap_error != 1): #curve = unknown  CHECK WITH CHIEF
                                ...
                                print("Using 'unknown' curve value, setting value to 1.00")
                                gamma_value = 1.00
                                gamma_node_made = 1
                                ...
                                # if(ShaderItem.bitmap_list[bitm].type == "base_map"):
                                    ...
                                    # #Attach the rgb of the texture node instead
                            ...
                            if(ShaderItem.bitmap_list[bitm].scale_uniform != 1.00 or ShaderItem.bitmap_list[bitm].scale_xy != [1.00,1.00] or ShaderItem.bitmap_list[bitm].translation_xy != [0.00,0.00]): #if the scale values are not default
                                ...
                                if (ShaderItem.bitmap_list[bitm].wrap_option == 3 or ShaderItem.bitmap_list[bitm].wrap_option == 13 or ShaderItem.bitmap_list[bitm].wrap_option == 2):
                                    ...
                                    if(ShaderItem.bitmap_list[bitm].wrap_option_type == 2):
                                        ...
                                        print("Changing Extension mode to Clip!")
                                        ImageTextureNodeList[bitm + 1].extension = 'CLIP'
                                    else: 
                                        print("Unhandled Wrap Option Type! Type: " + str(ShaderItem.bitmap_list[bitm].wrap_option_type))
                            ...
                            if((Shader_Type == 0 or Shader_Type == 2) and ShaderItem.bitmap_list[bitm].type == "base_map"): # and ShaderGroupList[bitm + 1] == "albedo"):
                                ...
                                if (ShaderItem.albedo_option == 2):
                                    ...
                                    if(ShaderItem.bitmap_list[bitm].curve_option == 1 or ShaderItem.bitmap_list[bitm].curve_option == 2):
                                        ...
                                        print("not doing anything with base map because Albedo Option is Constant Color")
                                    
                                        #Edit value of Gamma on node group
                                        #AlbedoGroup.inputs["base_map Gamma Curve"].default_value = gamma_value
                                        #print("Changing Gamma Value of " + ShaderItem.bitmap_list[bitm].type + " to: " + str(gamma_value))
                            ...
                            if((Shader_Type == 0 or Shader_Type == 2) and ShaderItem.bitmap_list[bitm].type == "detail_map3"): # and ShaderGroupList[bitm + 1] == "albedo"):
                                ...
                                if (ShaderItem.albedo_option == 5 and ShaderItem.material_model_option != 0):
                                    ...
                                    # if(ShaderItem.specular_mask_option == 1):
                                        ...
                                        # pymat_copy.node_tree.links.new(AlbedoGroup.inputs["detail_map.a"], ImageTextureNodeList[bitm + 1].outputs["Alpha"])
                            #DETAIL_MAP_OVERLAY
                            if((Shader_Type == 0 or Shader_Type == 2) and ShaderItem.bitmap_list[bitm].type == "detail_map_overlay"): # and ShaderGroupList[bitm + 1] == "albedo"):
                                print("  trying to link detail_map_overlay")
                                #if albedo option is not constant color
                            ...
                            if((Shader_Type == 0 or Shader_Type == 2) and ShaderItem.bitmap_list[bitm].type == "change_color_map"): # and ShaderGroupList[bitm + 1] == "albedo"):
                                print("  trying to link change_color_map")
                                #if albedo option is not constant color
                            ...
                            #Color_Mask_Map LINK
                            if((Shader_Type == 0 or Shader_Type == 2) and ShaderItem.bitmap_list[bitm].type == "color_mask_map"): # and ShaderGroupList[bitm + 1] == "albedo"):
                                print("  trying to link color_mask_map")
                                #if albedo option is not constant color
...
def handle_missing_texture(bitmap_path, texture_path):
    ...
    if(texture_exists(texture_path + bpy.context.scene.image_format) == True):
        print("Texture Exists!")
    else:
        print("Texture not found. Trying to create a new one.")
...
def convert_image_format(input_image_path, output_path, output_format):
    ...
    print(f'Removed {input_image_path}')
...
def convert_cubemap_to_equirectangular(cubemap_image_path):
    ...
    print("Trying to convert Environment Map to Equirectangular! Path: " + cubemap_image_path)
    ...
    print("Full Cubemap Path: " + cubemap_image_path)
