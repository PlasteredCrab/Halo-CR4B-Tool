...
class CR4B_ScanScenarioStructureBSP(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        context.scene.cr4b_last_tag = context.scene.tag_dropdown
        ...
        # Scan for files and populate the list
        # You can replace this logic with your specific scanning code
        ...
        if (import_type == "ass"):
            for file_path in new_files:
                try:
                    ...
                    print(f"Blender Toolset Could Not Import the file!")    
...
# def run_cr4b_tool(context):
    ...
    # if tag_type == 'Halo 3':
        # log_to_file("Trying to update halo3 tag path")
